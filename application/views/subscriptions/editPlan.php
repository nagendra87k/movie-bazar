            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary" style="border:2px solid #1d4650;">
                    <div class="box-header">
                        <h3 class="box-title">Update Plan Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
                    <form id="plan"  action="" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="name">Name</label>
                                        <input type="text" class="form-control required" value="<?=$plans->name; ?>" id="name" name="name" maxlength="128">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  id="alias_name" name="alias_name" maxlength="128" value="<?=$plans->alias_name; ?>">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  id="amount" name="amount" maxlength="128" value="<?=(!empty($plans->amount))?$plans->amount:''; ?>">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control"><?=$plans->description; ?></textarea>
                                    </div>
							 ...
							 <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="days" class="form-control"><?=$plans->days; ?></textarea>
                                    </div>
