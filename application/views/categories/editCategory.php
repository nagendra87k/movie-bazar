        ...
        <div class="row">
            <div class="col-md-8">
                <h3 style="color:white; margin-left: 5px;">
                    <i class="fa fa-list-alt"></i> Update Category
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary" style="border:2px solid #1d4650;">
                    ...
                    <form role="form" id="editCategory" action="" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="name">Name</label>
                                        <input type="text" class="form-control required" value="<?=$name; ?>" id="name" name="name" maxlength="128">
                                        <input type="hidden" value="<?=$id; ?>" name="categoryId" id="categoryId" />
                                    </div>
