                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input name="starring" class="form-control" type="text" value="<?=$cast->starring;?>"/>
                                    </div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input name="screenplay_by" class="form-control" type="text" value="<?=$cast->screenplay_by;?>"/>
                                    </div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input name="story_by"  class="form-control" type="text" value="<?=$cast->story_by;?>"/>
                                    </div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input name="music_by"  class="form-control" type="text" value="<?=$cast->music_by;?>"/>
                                    </div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input name="cinematography"  class="form-control" type="text" value="<?=$cast->cinematography;?>"/>
                                    </div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input name="edited_by"  class="form-control" type="text" value="<?=$cast->edited_by;?>"/>
                                    </div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input name="produced_by"  class="form-control" type="text" value="<?=$cast->produced_by;?>"/>
                                    </div>
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input name="production_company"  class="form-control" type="text" value="<?=$cast->production_company;?>"/>
                                    </div>
                                </div>
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <label for="name">Distributed by:</label>
                                        <input name="distributed_by"  class="form-control" type="text" value="<?=$cast->distributed_by;?>"/>
                                    </div>
