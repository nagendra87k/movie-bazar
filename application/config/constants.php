...
define('EMAIL_FROM',                            'raj@filmbazaarworldwide.com');		// e.g. email@example.com
define('EMAIL_BCC',                            	'Your bcc email');		// e.g. email@example.com
define('FROM_NAME',                             'Movie Bazar Admin System');	// Your system name
define('EMAIL_PASS',                            'Your email password');	// Your email password
define('PROTOCOL',                             	'mail');				// mail, sendmail, smtp
